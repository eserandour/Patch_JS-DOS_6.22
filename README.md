...
Pour lister les fichiers concernés par le problème, on utilise : liste-jsdos.sh (script Bash )<br>
Pour réparer les fichiers concernés par le problème, on utilise : reparer-jsdos.sh (script Bash )<br>
